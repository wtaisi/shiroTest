	...
	<div id="outer">
		<div id="middle">
			<div id="inner">
				<div id="content">
					<div id="top">
						<img src="images/login-logo.jpg" width="100%" height="100px"></img>
					</div>
					<div id="bottom" align="center">
						...
						<form id=loginform method=post name=loginform
							action="login.do?main">
							用户名：<input type=text id=userName name=usercode
								class="input_border" maxlength=16 />
							<p />
							密<span style="visibility: hidden">码</span>码：<input type=password
								id=password name=password class="input_border" />
							</p>
							<%--
